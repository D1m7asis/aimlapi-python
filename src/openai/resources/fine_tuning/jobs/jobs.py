...
class Jobs(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        [Learn more about fine-tuning](https://docs.aimlapi.com/docs/guides/model-optimization)

        Args:
          model: The name of the model to fine-tune. You can select one of the
              [supported models](https://docs.aimlapi.com/docs/guides/fine-tuning#which-models-can-be-fine-tuned).
          ...
          training_file: The ID of an uploaded file that contains training data.
              ...
              [preference](https://docs.aimlapi.com/docs/api-reference/fine-tuning/preference-input)
              format.

              See the
              [fine-tuning guide](https://docs.aimlapi.com/docs/guides/model-optimization)
              for more details.
          ...
          suffix: A string of up to 64 characters that will be added to your fine-tuned model
              ...
              `ft:gpt-4o-mini:aimlapi:custom-model-name:7p4lURel`.
