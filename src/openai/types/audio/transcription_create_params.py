...
class TranscriptionCreateParamsBase(TypedDict, total=False):
    ...
    The [prompt](https://docs.aimlapi.com/docs/guides/speech-to-text#prompting)
...
class TranscriptionCreateParamsNonStreaming(TranscriptionCreateParamsBase, total=False):
    ...
    See the
    [Streaming section of the Speech-to-Text guide](https://docs.aimlapi.com/docs/guides/speech-to-text?lang=curl#streaming-transcriptions)
